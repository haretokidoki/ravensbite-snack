  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="#" target="_blank">
        <i class="material-icons opacity-10 navbar-brand-image h-100" style="color: white">icecream</i>
        <span class="ms-1 font-weight-bold text-white">PT. RAVENSBITE SNACK</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link text-white" href="dashboard_pegawai.php">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="presensi.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <?php  
          if ($_SESSION['priv'] == "kadiv") {
            echo '
              <li class="nav-item">
                <a class="nav-link text-white " href="jurnal.php">
                  <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <!-- <li class="nav-item">
          <a class="nav-link text-white " href="permohonan-cuti.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">do_not_disturb_on</i>
            </div>
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="cek_gaji.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">receipt_long</i>
            </div>
            <span class="nav-link-text ms-1">Cek Gaji</span>
          </a>
        </li>
        <li class="nav-item">
